...
import {Modal,TouchableHighlight, ImageBackground, Image, View, Text, StyleSheet, TextInput } from 'react-native';
...
class Field extends Component{
    ...
    headerView(){
      return(
        ...
        { ((this.props.fieldName || 'No Data').length > 25) ? 
              (((this.props.fieldName || 'No Data').substring(0,25-3)) + '...') : 
              this.props.fieldName || 'No Data' }
          </Text>
               </View>
      ...
      return(
        ...
        <View style={styles.row}>
          <View style={{flexGrow:1,flexDirection:"row"}}>
            ...
            <TouchableOpacity
              onPress={() => alert("Adress","Chroy Jong Var, Phnom Penh, Cambodia")}
            >

            <Text numberOfLines={1} >
            { (("Chroy Jong Var, Phnom Penh, Cambodia").length > 15) ? 
              ((("Chroy Jong Var, Phnom Penh, Cambodia").substring(0,22-3)) + '...') : 
              "Chroy Jong Var, Phnom Penh, Cambodia" }
            </Text>
              </TouchableOpacity>
          </View>
          <TouchableOpacity>
        ...
        <View style={styles.row}>
          ...
          <Text numberOfLines={1}>012 12 32 32, 0123 23 42 33</Text>
        </View>
        <View style={styles.row}>
        <Text style={{color:"#747474", fontSize:13}}>Open from 7:00am - 8:00pm</Text>
        </View>
      </View>
    ...
    bookingFrom(){
      return(
        ...
        <RadioForm
          radio_props={[
            {label: 'តារាងធំ (40m × 60m) (ម្ខាង11នាក់)', value: 0 },
            {label: 'តារាងតូច (20m × 40m) (ម្ខាង6នាក់)', value: 1 }
          ]}
          initial={0}
          buttonSize={15}
            ...
            >
              ...
              <View style={{backgroundColor:"#fff", margin:30,padding:30,borderRadius:10}}>
                ...
                >
                  ...
                  { ((this.props.fieldName || 'No Data').length > 15) ? 
              (((this.props.fieldName || 'No Data').substring(0,15-3)) + '...') : 
              this.props.fieldName || 'No Data' }
                    </Text>
